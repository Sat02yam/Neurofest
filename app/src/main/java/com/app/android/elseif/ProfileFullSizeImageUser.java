...
public class ProfileFullSizeImageUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerView = findViewById(R.id.video_player_profile_feedp);
        progressBar = findViewById(R.id.progressBarProfileVideoActivityp);
...
//                    Log.d("report_detail" , list.get(position).getCoordinates());
            ...
            if (type.equals("photo")) {
                ...
                MediaItem mediaItem = MediaItem.fromUri(Uri.parse(postImage));
                ...
                exoPlayer.addListener(new Player.Listener() {
                    ...
                    public void onPlayerError(PlaybackException error) {
                        ...
                        Toast.makeText(ProfileFullSizeImageUser.this, "Error playing this video format", Toast.LENGTH_LONG).show();

                    }
                });

            }
            getlikebuttonstatus(path, uid);
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (getIntent().getExtras().getString("type").equals("video")) {
            releasePlayer();
        }
