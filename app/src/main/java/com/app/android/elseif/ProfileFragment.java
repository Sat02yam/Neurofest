    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (preferences.contains(MainActivityContainingFragment.PROFILE_IMAGE) && preferences.contains(MainActivityContainingFragment.USER_NAME)
            ...
            Glide.with(view.getContext())
                    ...
                    .placeholder(R.drawable.vlog)
                    .error(R.drawable.vlog)
                    .into(profileImage);
        ...
        settingsHamburger.setOnClickListener(viewa -> {
            ...
            bottomSheetView.findViewById(R.id.settings_password).setOnClickListener(view17 -> {
                bottomSheetDialog.dismiss();
                Intent intent = new Intent(getContext(), ChangePassword.class);
                startActivity(intent);
            });
            bottomSheetView.findViewById(R.id.settings_about).setOnClickListener(view113 -> {
                bottomSheetDialog.dismiss();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bottomSheetView.findViewById(R.id.upload_video_layout_bottom).setOnClickListener(view112 -> {
                    bottomSheetDialog.dismiss();
//                    Intent intent = new Intent(getContext(), AddVideoActivity.class);
                    Intent intent = new Intent(getContext(), AddVideoActivity.class);
                    intent.putExtra(POST_TYPE_PREFERENCE, "video");
                    startActivity(intent);
                });
